...
func request_PhotosService_SetMainPhotoGroup_0(ctx context.Context, marshaler runtime.Marshaler, client PhotosServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_PhotosService_SetMainPhotoGroup_0(ctx context.Context, marshaler runtime.Marshaler, server PhotosServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetMainPhotoGroupRequest
	var metadata runtime.ServerMetadata
...
func RegisterPhotosServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PhotosServiceServer) error {
	...
	mux.Handle("POST", pattern_PhotosService_SetMainPhotoGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.v1.PhotosService/SetMainPhotoGroup", runtime.WithHTTPPathPattern("/v1/photos/groups/main_photo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PhotosService_SetMainPhotoGroup_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PhotosService_SetMainPhotoGroup_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPhotosServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PhotosServiceClient) error {
	...
	mux.Handle("POST", pattern_PhotosService_SetMainPhotoGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.v1.PhotosService/SetMainPhotoGroup", runtime.WithHTTPPathPattern("/v1/photos/groups/main_photo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PhotosService_SetMainPhotoGroup_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_PhotosService_SetMainPhotoGroup_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "photos", "groups", "main_photo"}, ""))
)
...
var (
	...
	forward_PhotosService_SetMainPhotoGroup_0 = runtime.ForwardResponseMessage
)
